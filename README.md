...
# 📖 [Data Performance Audit] <a name="about-project"></a>

**[Data Performance Audit]** is a PostgreSQL database that contains information on animals, their owners, the vets and visitations.
...
```sh
  git clone https://github.com/Mikey1-nuel/database-performance-audit.git
...
Feel free to check the [issues page](https://github.com/Mikey1-nuel/database-performance-audit/issues).
